...
eeg1_1, labels_1, len_1, eeg1_m1, eeg1_std1 = new_signal_extract(path_1, path_2, channel='eeg1', filter=True,
                                                                 freq=[0.2, 40])
eog_1, _, len_1, eog_m1, eog_std1 = new_signal_extract(path_1, path_2, channel='eog', filter=True, freq=[0.2, 40])
...
class SleepEDF_Seq_MultiChan_Dataset_Inference(Dataset):
    ...
    def __len__(self):
        print("__LEN__",self.eeg.shape[0] - self.num_seq)
