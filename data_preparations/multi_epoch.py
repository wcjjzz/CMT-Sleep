...
eeg1_1, labels_1, len_1, eeg1_m1, eeg1_std1 = signal_extract_sequential(sub_1, days, channel='eeg1', filter=True,
...
eeg1_2, labels_2, len_2, eeg1_m2, eeg1_std2 = signal_extract_sequential(sub_2, days, channel='eeg1', filter=True,
                                                                        freq=[0.2, 40], stride=5)
...
eeg1_3, labels_3, len_3, eeg1_m3, eeg1_std3 = signal_extract_sequential(sub_3, days, channel='eeg1', filter=True,
                                                                        freq=[0.2, 40], stride=5)
...
eeg1_4, labels_4, len_4, eeg1_m4, eeg1_std4 = signal_extract_sequential(sub_4, days, channel='eeg1', filter=True,
                                                                        freq=[0.2, 40], stride=5)
...
eeg1_5, labels_5, len_5, eeg1_m5, eeg1_std5 = signal_extract_sequential(sub_5, days, channel='eeg1', filter=True,
                                                                        freq=[0.2, 40], stride=5)
...
eog1, labels_1, len_1, eog_m1, eog_std1 = signal_extract_sequential(sub_1, days, channel='eog', filter=True,
                                                                    freq=[0.2, 40], stride=5)
...
eog2, labels_2, len_2, eog_m2, eog_std2 = signal_extract_sequential(sub_2, days, channel='eog', filter=True,
                                                                    freq=[0.2, 40], stride=5)
...
eog3, labels_3, len_3, eog_m3, eog_std3 = signal_extract_sequential(sub_3, days, channel='eog', filter=True,
                                                                    freq=[0.2, 40], stride=5)
...
eog4, labels_4, len_4, eog_m4, eog_std4 = signal_extract_sequential(sub_4, days, channel='eog', filter=True,
                                                                    freq=[0.2, 40], stride=5)
...
eog5, labels_5, len_5, eog_m5, eog_std5 = signal_extract_sequential(sub_5, days, channel='eog', filter=True,
                                                                    freq=[0.2, 40], stride=5)
