...
def parse_option():
    ...
    parser.add_argument('--model_path', type=str, default="./results/retraining",   help='Path to saved checkpoint for retraining')
    ...
    parser.add_argument('--n_epochs', type=int, default = 20 ,  help='No of training epochs')
...
#Windows
#python cmt_training.py --project_path "./results" --data_path "D:\AIGC\Cross-Modal-Transformer\datasets\extract_dataset_single_epoch" --train_data_list [0,1,2,3] --val_data_list [4] --model_type "Epoch"