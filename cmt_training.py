...
'''
Training Epoch CMT 运行口令

python cmt_training.py --project_path "output" --data_path "C:\\Users\Tian_Yumi\Documents\GitHub\CMT-Sleep\data_preparations\extract_dataset_multi_epoch_hospital" --train_data_list [0,1,2,3] --val_data_list [4] --model_type "Seq" 
'''
