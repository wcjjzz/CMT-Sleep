...
path_2 = 'C:\\Users\\25975\\mne_data\\physionet-sleep-data\\SC4381FC-Hypnogram.edf'
...
print("len of infer_data_loader: ",len(infer_data_loader))
...
with torch.no_grad():  # 确保在接下来的代码块中不会计算梯度
    ...
    for batch_val_idx, data_val in enumerate(infer_data_loader):  # 遍历数据加载器中的每个批次
        ...
        # print(pred_val_main[batch_val_idx ])
